...
describe("formatResultsJson", () => {
    test("formats results as JSON", () => {
        ...
        expect(parsed[0]).toEqual({ title: "Title 1", url: "https://example.com/1", description: "Snippet 1" });
        expect(parsed[1]).toEqual({ title: "Title 2", url: "https://example.com/2", description: "Snippet 2" });
    });
